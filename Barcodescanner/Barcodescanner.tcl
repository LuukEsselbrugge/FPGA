...
# File: Barcodescanner.tcl
# Generated on: Sat Jun  6 17:34:20 2020
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "Barcodescanner"]} {
		puts "Project Barcodescanner is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists Barcodescanner]} {
		project_open -revision barcodescanner Barcodescanner
	} else {
		project_new -revision barcodescanner Barcodescanner
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "16:36:06  MEI 11, 2020"
	...
	set_global_assignment -name VERILOG_FILE camera/Video/D8M/int_line.v
	set_global_assignment -name VERILOG_FILE camera/Video/D8M/VGA_READ_COUNTER.v
	set_global_assignment -name VERILOG_FILE camera/Video/D8M/RAW_RGB_BIN.v
	set_global_assignment -name VERILOG_FILE camera/Video/D8M/RAW2RGB_L.v
	set_global_assignment -name VERILOG_FILE camera/Video/D8M/Line_Buffer_J.v
	set_global_assignment -name QIP_FILE camera/Video/D8M/int_line.qip
	set_global_assignment -name VERILOG_FILE camera/Video/D8M/D8M_WRITE_COUNTER.v
	set_global_assignment -name VERILOG_FILE camera/Video/D8M/D8M_SET.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/MIPI_CAMERA_CONFIG.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/MIPI_BRIDGE_CONFIG.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/MIPI_BRIDGE_CAMERA_Config.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/I2C_WRITE_WDATA.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/I2C_WRITE_PTR.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/I2C_RESET_DELAY.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/I2C_READ_DATA.v
	set_global_assignment -name VERILOG_FILE camera/Video/MIPI_CAMERA/CLOCKMEM.v
	set_global_assignment -name SOURCE_FILE camera/Video/VGA_Param.h
	set_global_assignment -name VERILOG_FILE camera/Video/VGA_Controller_trig.v
	set_global_assignment -name VERILOG_FILE camera/Video/RESET_DELAY.v
	set_global_assignment -name QIP_FILE camera/Video/pll_test.qip
	set_global_assignment -name VERILOG_FILE camera/Video/D8M_LUT.v
	set_global_assignment -name VERILOG_FILE camera/Video/CLOCK_DELAY.v
	set_global_assignment -name VERILOG_FILE camera/camera.v
	set_global_assignment -name BDF_FILE test.bdf
	set_global_assignment -name VERILOG_FILE NIOS.v
	set_global_assignment -name QSYS_FILE barcodescanner_nios.qsys
	set_global_assignment -name BDF_FILE ClockTest.bdf
	set_global_assignment -name VHDL_FILE VGA.vhd
	set_global_assignment -name VHDL_FILE ClockConvertervhd.vhd
	set_global_assignment -name VHDL_FILE Clock.vhd
	set_global_assignment -name QIP_FILE barcodescanner_nios/synthesis/barcodescanner_nios.qip
	set_global_assignment -name BDF_FILE barcodescanner.bdf
	set_global_assignment -name QIP_FILE my_pll.qip
	set_global_assignment -name QIP_FILE my_ddio_out.qip
	...
	set_location_assignment PIN_AG22 -to CAMERA_I2C_SCL
	set_location_assignment PIN_AE24 -to CAMERA_I2C_SDA
	set_location_assignment PIN_AE25 -to CAMERA_PWDN_n
	set_location_assignment PIN_AD25 -to MIPI_CS_n
	set_location_assignment PIN_AE20 -to MIPI_I2C_SCL
	set_location_assignment PIN_AG23 -to MIPI_I2C_SDA
	set_location_assignment PIN_AH22 -to MIPI_MCLK
	set_location_assignment PIN_AC15 -to MIPI_PIXEL_CLK
	set_location_assignment PIN_Y17 -to MIPI_PIXEL_D[0]
	set_location_assignment PIN_AC21 -to MIPI_PIXEL_D[1]
	set_location_assignment PIN_Y16 -to MIPI_PIXEL_D[2]
	set_location_assignment PIN_AD21 -to MIPI_PIXEL_D[3]
	set_location_assignment PIN_AE16 -to MIPI_PIXEL_D[4]
	set_location_assignment PIN_AD15 -to MIPI_PIXEL_D[5]
	set_location_assignment PIN_AE15 -to MIPI_PIXEL_D[6]
	set_location_assignment PIN_AC19 -to MIPI_PIXEL_D[7]
	set_location_assignment PIN_AF16 -to MIPI_PIXEL_D[8]
	set_location_assignment PIN_AD19 -to MIPI_PIXEL_D[9]
	set_location_assignment PIN_AG25 -to MIPI_PIXEL_HS
	set_location_assignment PIN_AF22 -to MIPI_PIXEL_VS
	set_location_assignment PIN_AE22 -to MIPI_REFCLK
	set_location_assignment PIN_AH25 -to MIPI_RESET_n
