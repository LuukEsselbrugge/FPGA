...
module barcodescanner_nios_mm_interconnect_0 (
	...
	wire  [107:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> sgdma_tx_descriptor_read_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                        // sgdma_tx_descriptor_read_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [7:0] rsp_mux_001_src_channel;                                                      // rsp_mux_001:src_channel -> sgdma_tx_descriptor_read_agent:rp_channel
	...
	wire  [107:0] rsp_mux_002_src_data;                                                         // rsp_mux_002:src_data -> sgdma_rx_descriptor_read_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                        // sgdma_rx_descriptor_read_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [7:0] rsp_mux_002_src_channel;                                                      // rsp_mux_002:src_channel -> sgdma_rx_descriptor_read_agent:rp_channel
	...
	wire  [107:0] rsp_mux_003_src_data;                                                         // rsp_mux_003:src_data -> sgdma_tx_descriptor_write_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                        // sgdma_tx_descriptor_write_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [7:0] rsp_mux_003_src_channel;                                                      // rsp_mux_003:src_channel -> sgdma_tx_descriptor_write_agent:rp_channel
	...
	wire  [107:0] rsp_mux_004_src_data;                                                         // rsp_mux_004:src_data -> sgdma_rx_descriptor_write_agent:rp_data
	wire          rsp_mux_004_src_ready;                                                        // sgdma_rx_descriptor_write_agent:rp_ready -> rsp_mux_004:src_ready
	wire    [7:0] rsp_mux_004_src_channel;                                                      // rsp_mux_004:src_channel -> sgdma_rx_descriptor_write_agent:rp_channel
	...
	wire  [108:0] eth_tse_control_port_agent_rf_source_data;                                    // eth_tse_control_port_agent:rf_source_data -> eth_tse_control_port_agent_rsp_fifo:in_data
	...
	wire  [108:0] eth_tse_control_port_agent_rsp_fifo_out_data;                                 // eth_tse_control_port_agent_rsp_fifo:out_data -> eth_tse_control_port_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_001_src_data;                                                         // cmd_mux_001:src_data -> eth_tse_control_port_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                        // eth_tse_control_port_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                                      // cmd_mux_001:src_channel -> eth_tse_control_port_agent:cp_channel
	...
	wire    [7:0] cmd_mux_005_src_channel;                                                      // cmd_mux_005:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [108:0] videoram_s1_agent_rf_source_data;                                             // VideoRAM_s1_agent:rf_source_data -> VideoRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] videoram_s1_agent_rsp_fifo_out_data;                                          // VideoRAM_s1_agent_rsp_fifo:out_data -> VideoRAM_s1_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_007_src_data;                                                         // cmd_mux_007:src_data -> VideoRAM_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                        // VideoRAM_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                      // cmd_mux_007:src_channel -> VideoRAM_s1_agent:cp_channel
	...
	wire  [107:0] sgdma_tx_descriptor_read_agent_cp_data;                                       // sgdma_tx_descriptor_read_agent:cp_data -> router_001:sink_data
	...
	wire  [107:0] sgdma_rx_descriptor_read_agent_cp_data;                                       // sgdma_rx_descriptor_read_agent:cp_data -> router_002:sink_data
	...
	wire  [107:0] sgdma_tx_descriptor_write_agent_cp_data;                                      // sgdma_tx_descriptor_write_agent:cp_data -> router_003:sink_data
	...
	wire  [107:0] sgdma_rx_descriptor_write_agent_cp_data;                                      // sgdma_rx_descriptor_write_agent:cp_data -> router_004:sink_data
	...
	wire  [107:0] eth_tse_control_port_agent_rp_data;                                           // eth_tse_control_port_agent:rp_data -> router_009:sink_data
	...
	wire  [107:0] onchip_memory_s1_agent_rp_data;                                               // onchip_memory_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [107:0] videoram_s1_agent_rp_data;                                                    // VideoRAM_s1_agent:rp_data -> router_015:sink_data
	...
	barcodescanner_nios_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (sys_clk_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
