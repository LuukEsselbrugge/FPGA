...
// ============================================================
// Megafunction Name(s):
// 			barcodescanner_nios_ddr2_memory_phy_alt_mem_phy
// ============================================================
...
module barcodescanner_nios_ddr2_memory_phy (
	pll_ref_clk,
	global_reset_n,
	soft_reset_n,
	ctl_dqs_burst,
	...
	barcodescanner_nios_ddr2_memory_phy_alt_mem_phy	barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst(
	...
	defparam
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "HIGH",
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN3",
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DQS_PHASE = 9000,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 3,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 8,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 1,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 1,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 5000,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "5000 ps",
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1074,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1024,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 48,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="barcodescanner_nios_ddr2_memory_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_seq_wrapper;+barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_reconfig;+barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_pll;+barcodescanner_nios_ddr2_memory_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/tmp/alt8394_8765688780980227867.dir/0002_iptb_gen/barcodescanner_nios_ddr2_memory_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="barcodescanner_nios_ddr2_memory_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
